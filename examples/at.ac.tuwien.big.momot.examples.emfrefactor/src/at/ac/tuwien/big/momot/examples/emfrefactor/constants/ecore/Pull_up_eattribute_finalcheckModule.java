...
public interface Pull_up_eattribute_finalcheckModule {
   public static interface Check_equivalents {
      static interface Parameter {
         String SELECTED_E_ATTRIBUTE = Check_equivalents.NAME + Pull_up_eattribute_finalcheckModule.SEPARATOR
               + "selectedEAttribute";
         String E_ATTRIBUTE_NAME = Check_equivalents.NAME + Pull_up_eattribute_finalcheckModule.SEPARATOR
               + "eAttributeName";
         String E_ATTRIBUTE_ID = Check_equivalents.NAME + Pull_up_eattribute_finalcheckModule.SEPARATOR
               + "eAttributeId";
         String SUPER_E_CLASS = Check_equivalents.NAME + Pull_up_eattribute_finalcheckModule.SEPARATOR + "superEClass";
      }

      static String NAME = Pull_up_eattribute_finalcheckModule.MODULE + Pull_up_eattribute_finalcheckModule.SEPARATOR
            + "check_equivalents";
   }

   public static interface Check_input {
      static interface Parameter {
         String SELECTED_E_ATTRIBUTE = Check_input.NAME + Pull_up_eattribute_finalcheckModule.SEPARATOR
               + "selectedEAttribute";
