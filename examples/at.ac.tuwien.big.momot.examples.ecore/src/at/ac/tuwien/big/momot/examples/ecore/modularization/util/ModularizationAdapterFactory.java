...
public class ModularizationAdapterFactory extends AdapterFactoryImpl {
   ...
   protected ModularizationSwitch<Adapter> modelSwitch = new ModularizationSwitch<Adapter>() {
      ...
      @Override
      public Adapter caseLanguage(final Language object) {
      ...
      @Override
      public Adapter caseRelationship(final Relationship object) {
   ...
   /**
    * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.ecore.modularization.Entity
    * <em>Entity</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.ecore.modularization.Language
    * <em>Language</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
   ...
   /**
    * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.momot.examples.ecore.modularization.Module
    * <em>Module</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    ...
    * '{@link at.ac.tuwien.big.momot.examples.ecore.modularization.NamedElement <em>Named Element</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class
    * '{@link at.ac.tuwien.big.momot.examples.ecore.modularization.Relationship <em>Relationship</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
