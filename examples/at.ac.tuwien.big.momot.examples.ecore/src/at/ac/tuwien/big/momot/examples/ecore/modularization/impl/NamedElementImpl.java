 ...
 * </p>
 * <ul>
 * <li>{@link at.ac.tuwien.big.momot.examples.ecore.modularization.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
   ...
   public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
      switch(featureID) {
         case ModularizationPackage.NAMED_ELEMENT__NAME:
            return getName();
      }
   ...
   protected EClass eStaticClass() {
      return ModularizationPackage.Literals.NAMED_ELEMENT;
   }
   ...
   public void setName(final String newName) {
      ...
      if(eNotificationRequired()) {
         eNotify(
               new ENotificationImpl(this, Notification.SET, ModularizationPackage.NAMED_ELEMENT__NAME, oldName, name));
      }
   }
