...
public class ModularizationFitnessFunction extends EGraphMultiDimensionalFitnessFunction {
   ...
   protected LanguageMetrics getMetrics(final TransformationSolution solution) {
      final Object metrics = solution.getAttribute(ATTRIBUTE_METRICS);
   ...
   protected void preprocessEvaluation(final TransformationSolution solution) {
      solution.setAttribute(ATTRIBUTE_METRICS,
            MetricsCalculator.calculate(MomotUtil.getRoot(solution.execute(), Language.class)));
   }
}
