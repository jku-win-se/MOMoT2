 ...
 * generated by Xtext
 */
package at.ac.tuwien.big.momot.lang.ide.contentassist.antlr;

import at.ac.tuwien.big.momot.lang.ide.contentassist.antlr.internal.InternalMOMoTParser;
...
public class MOMoTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MOMoTGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MOMoTGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getEqualityHelperAccess().getAlternatives(), "rule__EqualityHelper__Alternatives");
			builder.put(grammarAccess.getFitnessDimensionSpecificationAccess().getAlternatives(), "rule__FitnessDimensionSpecification__Alternatives");
			builder.put(grammarAccess.getAnalysisCommandAccess().getAlternatives(), "rule__AnalysisCommand__Alternatives");
			builder.put(grammarAccess.getResultManagementCommandAccess().getAlternatives(), "rule__ResultManagementCommand__Alternatives");
			builder.put(grammarAccess.getObjectivesCommandAccess().getAlternatives_4_1_1(), "rule__ObjectivesCommand__Alternatives_4_1_1");
			builder.put(grammarAccess.getSolutionsCommandAccess().getAlternatives_4_1_1(), "rule__SolutionsCommand__Alternatives_4_1_1");
			builder.put(grammarAccess.getModelsCommandAccess().getAlternatives_4_1_1(), "rule__ModelsCommand__Alternatives_4_1_1");
			...
			builder.put(grammarAccess.getFitnessDimensionTypeAccess().getAlternatives(), "rule__FitnessDimensionType__Alternatives");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup(), "rule__MOMoTSearch__Group__0");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup_0(), "rule__MOMoTSearch__Group_0__0");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup_3(), "rule__MOMoTSearch__Group_3__0");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup_11(), "rule__MOMoTSearch__Group_11__0");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup_12(), "rule__MOMoTSearch__Group_12__0");
			builder.put(grammarAccess.getMOMoTSearchAccess().getGroup_13(), "rule__MOMoTSearch__Group_13__0");
			...
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup(), "rule__ModuleOrchestration__Group__0");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup_4(), "rule__ModuleOrchestration__Group_4__0");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup_5(), "rule__ModuleOrchestration__Group_5__0");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getGroup_6(), "rule__ModuleOrchestration__Group_6__0");
			builder.put(grammarAccess.getParmeterValueSpecificationAccess().getGroup(), "rule__ParmeterValueSpecification__Group__0");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getGroup(), "rule__SearchOrchestration__Group__0");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getGroup_17(), "rule__SearchOrchestration__Group_17__0");
			builder.put(grammarAccess.getInputModelAccess().getGroup(), "rule__InputModel__Group__0");
			builder.put(grammarAccess.getInputModelAccess().getGroup_4(), "rule__InputModel__Group_4__0");
			builder.put(grammarAccess.getAlgorithmListAccess().getGroup(), "rule__AlgorithmList__Group__0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getGroup(), "rule__FitnessFunctionSpecification__Group__0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getGroup_2(), "rule__FitnessFunctionSpecification__Group_2__0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getGroup_8(), "rule__FitnessFunctionSpecification__Group_8__0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getGroup_9(), "rule__FitnessFunctionSpecification__Group_9__0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getGroup_10(), "rule__FitnessFunctionSpecification__Group_10__0");
			builder.put(grammarAccess.getFitnessDimensionConstructorAccess().getGroup(), "rule__FitnessDimensionConstructor__Group__0");
			builder.put(grammarAccess.getFitnessDimensionXBaseAccess().getGroup(), "rule__FitnessDimensionXBase__Group__0");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getGroup(), "rule__FitnessDimensionOCL__Group__0");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getGroup_4(), "rule__FitnessDimensionOCL__Group_4__0");
			builder.put(grammarAccess.getDefExpressionAccess().getGroup(), "rule__DefExpression__Group__0");
			builder.put(grammarAccess.getAlgorithmSpecificationAccess().getGroup(), "rule__AlgorithmSpecification__Group__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup(), "rule__ExperimentOrchestration__Group__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_11(), "rule__ExperimentOrchestration__Group_11__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_12(), "rule__ExperimentOrchestration__Group_12__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_12_3(), "rule__ExperimentOrchestration__Group_12_3__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_12_3_1(), "rule__ExperimentOrchestration__Group_12_3_1__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_13(), "rule__ExperimentOrchestration__Group_13__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_13_3(), "rule__ExperimentOrchestration__Group_13_3__0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getGroup_13_3_2(), "rule__ExperimentOrchestration__Group_13_3_2__0");
			builder.put(grammarAccess.getCollectorArrayAccess().getGroup(), "rule__CollectorArray__Group__0");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_0(), "rule__AnalysisOrchestration__Group_0__0");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_1(), "rule__AnalysisOrchestration__Group_1__0");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_2(), "rule__AnalysisOrchestration__Group_2__0");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_3(), "rule__AnalysisOrchestration__Group_3__0");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroup_6(), "rule__AnalysisOrchestration__Group_6__0");
			builder.put(grammarAccess.getAnalysisGroupListAccess().getGroup(), "rule__AnalysisGroupList__Group__0");
			builder.put(grammarAccess.getIndicatorArrayAccess().getGroup(), "rule__IndicatorArray__Group__0");
			builder.put(grammarAccess.getShowArrayAccess().getGroup(), "rule__ShowArray__Group__0");
			builder.put(grammarAccess.getAnalysisGroupSpecificationAccess().getGroup(), "rule__AnalysisGroupSpecification__Group__0");
			builder.put(grammarAccess.getAlgorithmReferencesAccess().getGroup(), "rule__AlgorithmReferences__Group__0");
			builder.put(grammarAccess.getAlgorithmReferencesAccess().getGroup_2(), "rule__AlgorithmReferences__Group_2__0");
			builder.put(grammarAccess.getAlgorithmReferencesAccess().getGroup_2_1(), "rule__AlgorithmReferences__Group_2_1__0");
			builder.put(grammarAccess.getPrintAnalysisCommandAccess().getGroup(), "rule__PrintAnalysisCommand__Group__0");
			builder.put(grammarAccess.getSaveAnalysisCommandAccess().getGroup(), "rule__SaveAnalysisCommand__Group__0");
			builder.put(grammarAccess.getBoxplotCommandAccess().getGroup(), "rule__BoxplotCommand__Group__0");
			builder.put(grammarAccess.getResultManagementAccess().getGroup(), "rule__ResultManagement__Group__0");
			builder.put(grammarAccess.getResultManagementAccess().getGroup_2(), "rule__ResultManagement__Group_2__0");
			builder.put(grammarAccess.getObjectivesCommandAccess().getGroup(), "rule__ObjectivesCommand__Group__0");
			builder.put(grammarAccess.getObjectivesCommandAccess().getGroup_4_0(), "rule__ObjectivesCommand__Group_4_0__0");
			builder.put(grammarAccess.getObjectivesCommandAccess().getGroup_4_1_0(), "rule__ObjectivesCommand__Group_4_1_0__0");
			builder.put(grammarAccess.getObjectivesCommandAccess().getGroup_4_2(), "rule__ObjectivesCommand__Group_4_2__0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getGroup(), "rule__SolutionsCommand__Group__0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getGroup_4_0(), "rule__SolutionsCommand__Group_4_0__0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getGroup_4_1_0(), "rule__SolutionsCommand__Group_4_1_0__0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getGroup_4_2(), "rule__SolutionsCommand__Group_4_2__0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getGroup_4_3(), "rule__SolutionsCommand__Group_4_3__0");
			builder.put(grammarAccess.getModelsCommandAccess().getGroup(), "rule__ModelsCommand__Group__0");
			builder.put(grammarAccess.getModelsCommandAccess().getGroup_4_0(), "rule__ModelsCommand__Group_4_0__0");
			builder.put(grammarAccess.getModelsCommandAccess().getGroup_4_1_0(), "rule__ModelsCommand__Group_4_1_0__0");
			builder.put(grammarAccess.getModelsCommandAccess().getGroup_4_2(), "rule__ModelsCommand__Group_4_2__0");
			...
			builder.put(grammarAccess.getMOMoTSearchAccess().getPackageAssignment_0_1(), "rule__MOMoTSearch__PackageAssignment_0_1");
			builder.put(grammarAccess.getMOMoTSearchAccess().getImportSectionAssignment_1(), "rule__MOMoTSearch__ImportSectionAssignment_1");
			builder.put(grammarAccess.getMOMoTSearchAccess().getVariablesAssignment_2(), "rule__MOMoTSearch__VariablesAssignment_2");
			builder.put(grammarAccess.getMOMoTSearchAccess().getInitializationAssignment_3_2(), "rule__MOMoTSearch__InitializationAssignment_3_2");
			builder.put(grammarAccess.getMOMoTSearchAccess().getNameAssignment_5(), "rule__MOMoTSearch__NameAssignment_5");
			builder.put(grammarAccess.getMOMoTSearchAccess().getSearchOrchestrationAssignment_7(), "rule__MOMoTSearch__SearchOrchestrationAssignment_7");
			builder.put(grammarAccess.getMOMoTSearchAccess().getExperimentOrchestrationAssignment_10(), "rule__MOMoTSearch__ExperimentOrchestrationAssignment_10");
			builder.put(grammarAccess.getMOMoTSearchAccess().getAnalysisOrchestrationAssignment_11_2(), "rule__MOMoTSearch__AnalysisOrchestrationAssignment_11_2");
			builder.put(grammarAccess.getMOMoTSearchAccess().getResultManagementAssignment_12_2(), "rule__MOMoTSearch__ResultManagementAssignment_12_2");
			builder.put(grammarAccess.getMOMoTSearchAccess().getFinalizationAssignment_13_2(), "rule__MOMoTSearch__FinalizationAssignment_13_2");
			...
			builder.put(grammarAccess.getVariableDeclarationAccess().getInitAssignment_3_1(), "rule__VariableDeclaration__InitAssignment_3_1");
			builder.put(grammarAccess.getArrayLiteralAccess().getElementsAssignment_2(), "rule__ArrayLiteral__ElementsAssignment_2");
			builder.put(grammarAccess.getArrayLiteralAccess().getElementsAssignment_3_1(), "rule__ArrayLiteral__ElementsAssignment_3_1");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getModulesAssignment_3(), "rule__ModuleOrchestration__ModulesAssignment_3");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getUnitsToRemoveAssignment_4_2(), "rule__ModuleOrchestration__UnitsToRemoveAssignment_4_2");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getNonSolutionParametersAssignment_5_2(), "rule__ModuleOrchestration__NonSolutionParametersAssignment_5_2");
			builder.put(grammarAccess.getModuleOrchestrationAccess().getParameterValuesAssignment_6_3(), "rule__ModuleOrchestration__ParameterValuesAssignment_6_3");
			builder.put(grammarAccess.getParmeterValueSpecificationAccess().getNameAssignment_1(), "rule__ParmeterValueSpecification__NameAssignment_1");
			builder.put(grammarAccess.getParmeterValueSpecificationAccess().getCallAssignment_3(), "rule__ParmeterValueSpecification__CallAssignment_3");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getModelAssignment_4(), "rule__SearchOrchestration__ModelAssignment_4");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getSolutionLengthAssignment_7(), "rule__SearchOrchestration__SolutionLengthAssignment_7");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getModuleOrchestrationAssignment_10(), "rule__SearchOrchestration__ModuleOrchestrationAssignment_10");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getFitnessFunctionAssignment_13(), "rule__SearchOrchestration__FitnessFunctionAssignment_13");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getAlgorithmsAssignment_16(), "rule__SearchOrchestration__AlgorithmsAssignment_16");
			builder.put(grammarAccess.getSearchOrchestrationAccess().getEqualityHelperAssignment_17_2(), "rule__SearchOrchestration__EqualityHelperAssignment_17_2");
			builder.put(grammarAccess.getInputModelAccess().getPathAssignment_3(), "rule__InputModel__PathAssignment_3");
			builder.put(grammarAccess.getInputModelAccess().getAdaptationAssignment_4_2(), "rule__InputModel__AdaptationAssignment_4_2");
			builder.put(grammarAccess.getEqualityHelperAccess().getCallAssignment_0(), "rule__EqualityHelper__CallAssignment_0");
			builder.put(grammarAccess.getEqualityHelperAccess().getMethodAssignment_1(), "rule__EqualityHelper__MethodAssignment_1");
			builder.put(grammarAccess.getAlgorithmListAccess().getSpecificationsAssignment_1(), "rule__AlgorithmList__SpecificationsAssignment_1");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getConstructorAssignment_0(), "rule__FitnessFunctionSpecification__ConstructorAssignment_0");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getPreprocessAssignment_2_2(), "rule__FitnessFunctionSpecification__PreprocessAssignment_2_2");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getObjectivesAssignment_6(), "rule__FitnessFunctionSpecification__ObjectivesAssignment_6");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getConstraintsAssignment_8_3(), "rule__FitnessFunctionSpecification__ConstraintsAssignment_8_3");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getPostprocessAssignment_9_2(), "rule__FitnessFunctionSpecification__PostprocessAssignment_9_2");
			builder.put(grammarAccess.getFitnessFunctionSpecificationAccess().getSolutionRepairerAssignment_10_2(), "rule__FitnessFunctionSpecification__SolutionRepairerAssignment_10_2");
			builder.put(grammarAccess.getFitnessDimensionConstructorAccess().getNameAssignment_0(), "rule__FitnessDimensionConstructor__NameAssignment_0");
			builder.put(grammarAccess.getFitnessDimensionConstructorAccess().getTypeAssignment_2(), "rule__FitnessDimensionConstructor__TypeAssignment_2");
			builder.put(grammarAccess.getFitnessDimensionConstructorAccess().getCallAssignment_3(), "rule__FitnessDimensionConstructor__CallAssignment_3");
			builder.put(grammarAccess.getFitnessDimensionXBaseAccess().getNameAssignment_0(), "rule__FitnessDimensionXBase__NameAssignment_0");
			builder.put(grammarAccess.getFitnessDimensionXBaseAccess().getTypeAssignment_2(), "rule__FitnessDimensionXBase__TypeAssignment_2");
			builder.put(grammarAccess.getFitnessDimensionXBaseAccess().getValueAssignment_3(), "rule__FitnessDimensionXBase__ValueAssignment_3");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getNameAssignment_0(), "rule__FitnessDimensionOCL__NameAssignment_0");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getTypeAssignment_2(), "rule__FitnessDimensionOCL__TypeAssignment_2");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getQueryAssignment_3(), "rule__FitnessDimensionOCL__QueryAssignment_3");
			builder.put(grammarAccess.getFitnessDimensionOCLAccess().getDefExpressionsAssignment_4_1(), "rule__FitnessDimensionOCL__DefExpressionsAssignment_4_1");
			builder.put(grammarAccess.getDefExpressionAccess().getExpressionAssignment_1(), "rule__DefExpression__ExpressionAssignment_1");
			builder.put(grammarAccess.getAlgorithmSpecificationAccess().getNameAssignment_0(), "rule__AlgorithmSpecification__NameAssignment_0");
			builder.put(grammarAccess.getAlgorithmSpecificationAccess().getCallAssignment_2(), "rule__AlgorithmSpecification__CallAssignment_2");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getPopulationSizeAssignment_4(), "rule__ExperimentOrchestration__PopulationSizeAssignment_4");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getMaxEvaluationsAssignment_7(), "rule__ExperimentOrchestration__MaxEvaluationsAssignment_7");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getNrRunsAssignment_10(), "rule__ExperimentOrchestration__NrRunsAssignment_10");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getReferenceSetAssignment_11_2(), "rule__ExperimentOrchestration__ReferenceSetAssignment_11_2");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getProgressListenersAssignment_12_3_0(), "rule__ExperimentOrchestration__ProgressListenersAssignment_12_3_0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getProgressListenersAssignment_12_3_1_1(), "rule__ExperimentOrchestration__ProgressListenersAssignment_12_3_1_1");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getCollectorsAssignment_13_3_0(), "rule__ExperimentOrchestration__CollectorsAssignment_13_3_0");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getCustomCollectorsAssignment_13_3_1(), "rule__ExperimentOrchestration__CustomCollectorsAssignment_13_3_1");
			builder.put(grammarAccess.getExperimentOrchestrationAccess().getCustomCollectorsAssignment_13_3_2_1(), "rule__ExperimentOrchestration__CustomCollectorsAssignment_13_3_2_1");
			builder.put(grammarAccess.getCollectorArrayAccess().getHypervolumeAssignment_1_0(), "rule__CollectorArray__HypervolumeAssignment_1_0");
			builder.put(grammarAccess.getCollectorArrayAccess().getGenerationalDistanceAssignment_1_1(), "rule__CollectorArray__GenerationalDistanceAssignment_1_1");
			builder.put(grammarAccess.getCollectorArrayAccess().getInvertedGenerationalDistanceAssignment_1_2(), "rule__CollectorArray__InvertedGenerationalDistanceAssignment_1_2");
			builder.put(grammarAccess.getCollectorArrayAccess().getSpacingAssignment_1_3(), "rule__CollectorArray__SpacingAssignment_1_3");
			builder.put(grammarAccess.getCollectorArrayAccess().getAdditiveEpsilonIndicatorAssignment_1_4(), "rule__CollectorArray__AdditiveEpsilonIndicatorAssignment_1_4");
			builder.put(grammarAccess.getCollectorArrayAccess().getContributionAssignment_1_5(), "rule__CollectorArray__ContributionAssignment_1_5");
			builder.put(grammarAccess.getCollectorArrayAccess().getR1Assignment_1_6(), "rule__CollectorArray__R1Assignment_1_6");
			builder.put(grammarAccess.getCollectorArrayAccess().getR2Assignment_1_7(), "rule__CollectorArray__R2Assignment_1_7");
			builder.put(grammarAccess.getCollectorArrayAccess().getR3Assignment_1_8(), "rule__CollectorArray__R3Assignment_1_8");
			builder.put(grammarAccess.getCollectorArrayAccess().getAdaptiveMultimethodVariationAssignment_1_9(), "rule__CollectorArray__AdaptiveMultimethodVariationAssignment_1_9");
			builder.put(grammarAccess.getCollectorArrayAccess().getAdaptiveTimeContinuationAssignment_1_10(), "rule__CollectorArray__AdaptiveTimeContinuationAssignment_1_10");
			builder.put(grammarAccess.getCollectorArrayAccess().getApproximationSetAssignment_1_11(), "rule__CollectorArray__ApproximationSetAssignment_1_11");
			builder.put(grammarAccess.getCollectorArrayAccess().getEpsilonProgressAssignment_1_12(), "rule__CollectorArray__EpsilonProgressAssignment_1_12");
			builder.put(grammarAccess.getCollectorArrayAccess().getElapsedTimeAssignment_1_13(), "rule__CollectorArray__ElapsedTimeAssignment_1_13");
			builder.put(grammarAccess.getCollectorArrayAccess().getPopulationSizeAssignment_1_14(), "rule__CollectorArray__PopulationSizeAssignment_1_14");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getIndicatorsAssignment_0_3(), "rule__AnalysisOrchestration__IndicatorsAssignment_0_3");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getSignificanceAssignment_1_2(), "rule__AnalysisOrchestration__SignificanceAssignment_1_2");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getShowAssignment_2_2(), "rule__AnalysisOrchestration__ShowAssignment_2_2");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getGroupingAssignment_3_2(), "rule__AnalysisOrchestration__GroupingAssignment_3_2");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getSaveCommandAssignment_4(), "rule__AnalysisOrchestration__SaveCommandAssignment_4");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getBoxplotCommandAssignment_5(), "rule__AnalysisOrchestration__BoxplotCommandAssignment_5");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getPrintCommandAssignment_6_0(), "rule__AnalysisOrchestration__PrintCommandAssignment_6_0");
			builder.put(grammarAccess.getAnalysisGroupListAccess().getGroupAssignment_1(), "rule__AnalysisGroupList__GroupAssignment_1");
			builder.put(grammarAccess.getIndicatorArrayAccess().getHypervolumeAssignment_2_0(), "rule__IndicatorArray__HypervolumeAssignment_2_0");
			builder.put(grammarAccess.getIndicatorArrayAccess().getGenerationalDistanceAssignment_2_1(), "rule__IndicatorArray__GenerationalDistanceAssignment_2_1");
			builder.put(grammarAccess.getIndicatorArrayAccess().getInvertedGenerationalDistanceAssignment_2_2(), "rule__IndicatorArray__InvertedGenerationalDistanceAssignment_2_2");
			builder.put(grammarAccess.getIndicatorArrayAccess().getSpacingAssignment_2_3(), "rule__IndicatorArray__SpacingAssignment_2_3");
			builder.put(grammarAccess.getIndicatorArrayAccess().getAdditiveEpsilonIndicatorAssignment_2_4(), "rule__IndicatorArray__AdditiveEpsilonIndicatorAssignment_2_4");
			builder.put(grammarAccess.getIndicatorArrayAccess().getContributionAssignment_2_5(), "rule__IndicatorArray__ContributionAssignment_2_5");
			builder.put(grammarAccess.getIndicatorArrayAccess().getR1Assignment_2_6(), "rule__IndicatorArray__R1Assignment_2_6");
			builder.put(grammarAccess.getIndicatorArrayAccess().getR2Assignment_2_7(), "rule__IndicatorArray__R2Assignment_2_7");
			builder.put(grammarAccess.getIndicatorArrayAccess().getR3Assignment_2_8(), "rule__IndicatorArray__R3Assignment_2_8");
			builder.put(grammarAccess.getIndicatorArrayAccess().getMaximumParetoFrontErrorAssignment_2_9(), "rule__IndicatorArray__MaximumParetoFrontErrorAssignment_2_9");
			builder.put(grammarAccess.getShowArrayAccess().getIndividualAssignment_2_0(), "rule__ShowArray__IndividualAssignment_2_0");
			builder.put(grammarAccess.getShowArrayAccess().getAggregateAssignment_2_1(), "rule__ShowArray__AggregateAssignment_2_1");
			builder.put(grammarAccess.getShowArrayAccess().getStatisticalSignificanceAssignment_2_2(), "rule__ShowArray__StatisticalSignificanceAssignment_2_2");
			builder.put(grammarAccess.getAnalysisGroupSpecificationAccess().getNameAssignment_1(), "rule__AnalysisGroupSpecification__NameAssignment_1");
			builder.put(grammarAccess.getAnalysisGroupSpecificationAccess().getAlgorithmsAssignment_3(), "rule__AnalysisGroupSpecification__AlgorithmsAssignment_3");
			builder.put(grammarAccess.getAlgorithmReferencesAccess().getElementsAssignment_2_0(), "rule__AlgorithmReferences__ElementsAssignment_2_0");
			builder.put(grammarAccess.getAlgorithmReferencesAccess().getElementsAssignment_2_1_1(), "rule__AlgorithmReferences__ElementsAssignment_2_1_1");
			builder.put(grammarAccess.getSaveAnalysisCommandAccess().getFileAssignment_2(), "rule__SaveAnalysisCommand__FileAssignment_2");
			builder.put(grammarAccess.getBoxplotCommandAccess().getDirectoryAssignment_2(), "rule__BoxplotCommand__DirectoryAssignment_2");
			builder.put(grammarAccess.getResultManagementAccess().getAdaptModelsAssignment_2_2(), "rule__ResultManagement__AdaptModelsAssignment_2_2");
			builder.put(grammarAccess.getResultManagementAccess().getCommandsAssignment_3(), "rule__ResultManagement__CommandsAssignment_3");
			builder.put(grammarAccess.getObjectivesCommandAccess().getAlgorithmsAssignment_4_0_2(), "rule__ObjectivesCommand__AlgorithmsAssignment_4_0_2");
			builder.put(grammarAccess.getObjectivesCommandAccess().getNeighborhoodSizeAssignment_4_1_1_0(), "rule__ObjectivesCommand__NeighborhoodSizeAssignment_4_1_1_0");
			builder.put(grammarAccess.getObjectivesCommandAccess().getMaxNeighborhoodSizeAssignment_4_1_1_1(), "rule__ObjectivesCommand__MaxNeighborhoodSizeAssignment_4_1_1_1");
			builder.put(grammarAccess.getObjectivesCommandAccess().getFileAssignment_4_2_2(), "rule__ObjectivesCommand__FileAssignment_4_2_2");
			builder.put(grammarAccess.getObjectivesCommandAccess().getPrintOutputAssignment_4_3(), "rule__ObjectivesCommand__PrintOutputAssignment_4_3");
			builder.put(grammarAccess.getSolutionsCommandAccess().getAlgorithmsAssignment_4_0_2(), "rule__SolutionsCommand__AlgorithmsAssignment_4_0_2");
			builder.put(grammarAccess.getSolutionsCommandAccess().getNeighborhoodSizeAssignment_4_1_1_0(), "rule__SolutionsCommand__NeighborhoodSizeAssignment_4_1_1_0");
			builder.put(grammarAccess.getSolutionsCommandAccess().getMaxNeighborhoodSizeAssignment_4_1_1_1(), "rule__SolutionsCommand__MaxNeighborhoodSizeAssignment_4_1_1_1");
			builder.put(grammarAccess.getSolutionsCommandAccess().getFileAssignment_4_2_2(), "rule__SolutionsCommand__FileAssignment_4_2_2");
			builder.put(grammarAccess.getSolutionsCommandAccess().getDirectoryAssignment_4_3_2(), "rule__SolutionsCommand__DirectoryAssignment_4_3_2");
			builder.put(grammarAccess.getSolutionsCommandAccess().getPrintOutputAssignment_4_4(), "rule__SolutionsCommand__PrintOutputAssignment_4_4");
			builder.put(grammarAccess.getModelsCommandAccess().getAlgorithmsAssignment_4_0_2(), "rule__ModelsCommand__AlgorithmsAssignment_4_0_2");
			builder.put(grammarAccess.getModelsCommandAccess().getNeighborhoodSizeAssignment_4_1_1_0(), "rule__ModelsCommand__NeighborhoodSizeAssignment_4_1_1_0");
			builder.put(grammarAccess.getModelsCommandAccess().getMaxNeighborhoodSizeAssignment_4_1_1_1(), "rule__ModelsCommand__MaxNeighborhoodSizeAssignment_4_1_1_1");
			builder.put(grammarAccess.getModelsCommandAccess().getDirectoryAssignment_4_2_2(), "rule__ModelsCommand__DirectoryAssignment_4_2_2");
			builder.put(grammarAccess.getModelsCommandAccess().getPrintOutputAssignment_4_3(), "rule__ModelsCommand__PrintOutputAssignment_4_3");
			...
			builder.put(grammarAccess.getCollectorArrayAccess().getUnorderedGroup_1(), "rule__CollectorArray__UnorderedGroup_1");
			builder.put(grammarAccess.getAnalysisOrchestrationAccess().getUnorderedGroup(), "rule__AnalysisOrchestration__UnorderedGroup");
			builder.put(grammarAccess.getIndicatorArrayAccess().getUnorderedGroup_2(), "rule__IndicatorArray__UnorderedGroup_2");
			builder.put(grammarAccess.getShowArrayAccess().getUnorderedGroup_2(), "rule__ShowArray__UnorderedGroup_2");
			builder.put(grammarAccess.getObjectivesCommandAccess().getUnorderedGroup_4(), "rule__ObjectivesCommand__UnorderedGroup_4");
			builder.put(grammarAccess.getObjectivesCommandAccess().getUnorderedGroup_4_1(), "rule__ObjectivesCommand__UnorderedGroup_4_1");
			builder.put(grammarAccess.getSolutionsCommandAccess().getUnorderedGroup_4(), "rule__SolutionsCommand__UnorderedGroup_4");
			builder.put(grammarAccess.getSolutionsCommandAccess().getUnorderedGroup_4_1(), "rule__SolutionsCommand__UnorderedGroup_4_1");
			builder.put(grammarAccess.getModelsCommandAccess().getUnorderedGroup_4(), "rule__ModelsCommand__UnorderedGroup_4");
			builder.put(grammarAccess.getModelsCommandAccess().getUnorderedGroup_4_1(), "rule__ModelsCommand__UnorderedGroup_4_1");
		}
	}
	...
	@Override
	protected InternalMOMoTParser createParser() {
		InternalMOMoTParser result = new InternalMOMoTParser(null);
